  ...
  return (
    <>
      ...
      >
        ...
        <line className="cls-1" x1="7.95" y1="16.05" x2="4.75" y2="19.25" />
        <line className="cls-1" x1="19.25" y1="4.75" x2="16.05" y2="7.95" />
        <path
          className="cls-1"
          d="M17.73,12a5.74,5.74,0,1,1-1.68-4A5.69,5.69,0,0,1,17.73,12Z"
        />
        <line className="cls-1" x1="18.42" y1="18.42" x2="16.05" y2="16.05" />
        <line className="cls-1" x1="7.95" y1="7.95" x2="5.58" y2="5.58" />
      </svg>
    </>
  );
};
